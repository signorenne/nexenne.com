...
export const EXPERIENCE: ExperienceItem[] = [
	{
		...
		points: [
			'Contribute to firmware, HMI and product experience across Work Louder keyboards and controllers.',
			'Through Work Louder, contributed to the public collaboration with OpenAI on Codex Micro by translating Codex workflows into clear physical interactions.',
			'Contribute to Framer F1 firmware and HMI, keeping its display, controls and Framer-focused experience coherent.',
			'Support the evolution and continuity of Creator Micro 2, XYZ Work Board r2, Knob1 and Nomad [E] 2 through implementation, validation and ongoing refinement.'
		],
		tags: ['Embedded firmware', 'Product UX', 'HMI', 'Product integration', 'Validation']
	},
	{
		...
		points: [
			'Work with the SDF R&D team through Re:Lab on embedded software and HMI for onboard displays.',
			'Turn product requirements and machine information into clear, consistent behavior on the digital cluster.',
			'Develop software and interface components while preserving continuity across pages and operator contexts.',
			'Validate the experience on the reference platform and refine it with the multidisciplinary team.'
		],
...
export const NOW = [
	{
		...
		body: 'Developing Nomad [E] 2 and Framer F1 after shipping Codex Micro, while maintaining Creator Micro 2, XYZ Work Board r2 and Knob1.'
	},
	{
		time: 'weekly',
...
export const SIDEMAP_ROUTES: SidemapRoute[] = [
	...
	{ id: 'brand', code: '09', labelKey: 'sidemap.brand', hex: '0x9D' },
	{ id: 'terminal', code: '10', labelKey: 'sidemap.terminal', hex: '0xA7' },
	{ id: 'colophon', code: '11', labelKey: 'sidemap.colophon', hex: '0xAE' }
];
